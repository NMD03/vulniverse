...
The validator supports every non-EOL CPython feature release as of June 2026: **Python 3.10 through 3.14**. This keeps the compatibility intent from [PR #1](https://github.com/gcve-eu/bcp-validator/pull/1) while avoiding Python 3.12-only syntax so older supported interpreters continue to parse the script.
